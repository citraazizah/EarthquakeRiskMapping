package association_rule_apriori;
...
import association_rule_apriori.ArraysAlgos;
import association_rule_apriori.Itemset;
import association_rule_apriori.Itemsets;
import association_rule_apriori.MemoryLogger;
...
public class AlgoApriori {
     ...
     * Default constructor
     */
    public AlgoApriori() { //constractor
     ...
     * @param output the path of an input if the result should be saved to a
     * file. If null, the result will be kept into memory and this method will
     * return the result.
     * @throws IOException exception if error while writting or reading the
     * input/output file
     */
    
    public Itemsets runAlgorithm(double minsup, List<List<Integer>> inputData, String output) throws IOException {
        ...
        for (List<Integer> d : inputData) {
            int transaksi[] = new int[d.size()];
            for (int i = 0; i < d.size(); i++) {
                // transform this item from a string to an integer
                Integer item = d.get(i);
...
//					System.out.println("test");
    ...
    public void printStats() {
     ...
     Itemsets runAlgorithm(double minsup, String input, String output) throws IOException {
